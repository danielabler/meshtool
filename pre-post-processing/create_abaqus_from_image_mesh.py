...
if hostname == "danabl-ISTB":
    ...
    repository_base_path = "/Users/dabler/Documents/SoftwareDevelopment/cornea_meshing"

test_data_dir = os.path.join(repository_base_path, "test-data", "image", "output")
...
print("Trying to read VTU from '%s"%path_to_vtu_in)

# repository_base_path = "/Users/dabler/Downloads"
# path_to_vtu_in = os.path.join(repository_base_path, "test.vtu")
# path_to_abq_file = os.path.join(repository_base_path, 'test_fem',"test_fem.inp")
